(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&t(d)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const j=[["3","3 days"],["5","5 days"],["7","7 days"],["10","10 days"],["15","15 days"],["21","21 days"],["30","30 days"],["45","45 days"],["60","60 days"],["90_plus","90+ days"],["full","Full Grand Tour"]],q=["Autumn Colors","Mountains & Alps","Nature","Scenic Driving","Ancient History","Castles & Royal Europe","Art & Museums","Architecture & Churches","Coast & Fjords","Photography","Wine & Countryside","First-Time Europe Essentials"],V=["Target 120-180 mi/day on scenic travel days.","Comfortable upper target is about 220 mi/day on ordinary transfer days.","Avoid consecutive upper-limit drive days where possible.","Protect 2+ nights at high-value autumn or weather-sensitive bases.","Count parking, check-in, ferry, border, walking and reservation pressure as travel burden.","Do not schedule major scenic roads after dark."];function B(e){return{city_id:e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""),name:e,coordinate:{latitude:0,longitude:0,coordinate_precision:"approximate",coordinate_source:"CONTENT_PENDING",coordinate_verified_date:"CONTENT_PENDING"},first_time_summary:"CONTENT_PENDING",signature_story:"CONTENT_PENDING",recommended_nights:0,first_time_duration_guides:{"1_day":$("1-day must-see guide is awaiting approved research."),"2_days":$("2-day city-understanding guide is awaiting approved research."),"3_days":$("3-day complete first-visit guide is awaiting approved research."),"4_plus_days":$("4+ day relaxed/deeper guide is awaiting approved research.")},sources:[],status:"CONTENT_PENDING"}}function $(e){return{pace:"relaxed_balanced",must_see:[],schedule:[{label:"Approved research pack required",time_range:"CONTENT_PENDING",visit_duration:"recovery",status:"CONTENT_PENDING"}],notes:e,status:"CONTENT_PENDING"}}function F(e){const r=e.driveMiles?Math.max(.5,e.driveMiles/48):0,o=e.mountainRoadHours??0,t=e.majorAttractions??0,n=e.walkingHours??1.5,s=Math.min(100,Math.round(r*8+o*9+n*4+t*10+(e.hotelChange?12:0)+(e.ferry?10:0)));return{drive_miles:e.driveMiles,drive_hours:Number(r.toFixed(1)),mountain_road_hours:o,border_crossing:!1,ferry:!!e.ferry,hotel_change:e.hotelChange,major_attractions:t,walking_hours:n,reservation_pressure:t>1?"medium":"low",burden_score:s}}const w={title:"Europe Autumn Grand Tour",subtitle:"3D Virtual Road Trip Across Europe",myMapsOpen:"https://www.google.com/maps/d/edit?mid=1msDendyXwmU4o2SLgb1RbBBB7nJCBa4"},C="/travel-guide/",U=[{name:"03 DRIVE 1",from:"Amsterdam",to:"Lillehammer",opensAt:"Amsterdam"},{name:"04 DRIVE 2",from:"Lillehammer",to:"Warsaw",opensAt:"Lillehammer"},{name:"05 DRIVE 3",from:"Warsaw",to:"Grindelwald",opensAt:"Warsaw"},{name:"06 DRIVE 4",from:"Grindelwald",to:"Porto",opensAt:"Grindelwald"},{name:"07 DRIVE 5",from:"Porto",to:"Port of Barcelona",opensAt:"Porto"},{name:"08 DRIVE 6",from:"Civitavecchia",to:"Shkodër",opensAt:"Rome"},{name:"09 DRIVE 7",from:"Shkodër",to:"Belgrade",opensAt:"Shkodër"},{name:"10 DRIVE 8",from:"Belgrade",to:"Amsterdam Schiphol",opensAt:"Belgrade"}],R=document.querySelector("#app");let g=[],L=[],m=0,S="All",f="cn",E="daylight",c={duration:"full",visitorProfile:"first_time",pace:"relaxed",drivingPreference:"relaxed_self_drive",theme:"Autumn Colors"},b=0,_=!0,W=window.matchMedia("(prefers-reduced-motion: reduce)").matches;function k(e){const r=[];let o=[],t="",n=!1;for(let d=0;d<e.length;d+=1){const u=e[d],l=e[d+1];u==='"'&&n&&l==='"'?(t+='"',d+=1):u==='"'?n=!n:u===","&&!n?(o.push(t),t=""):(u===`
`||u==="\r")&&!n?(u==="\r"&&l===`
`&&(d+=1),o.push(t),o.some(a=>a.trim())&&r.push(o),o=[],t=""):t+=u}(t||o.length)&&(o.push(t),r.push(o));const s=r.shift()??[];return r.map(d=>Object.fromEntries(s.map((u,l)=>[u,d[l]??""])))}function A(e){return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(e)}`}function M(e){return`https://earth.google.com/web/search/${encodeURIComponent(e)}`}function x(e){return`https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=${encodeURIComponent(e)}`}function H(e,r){return`https://www.google.com/maps/@?api=1&map_action=pano&viewpoint=${e},${r}`}function D(e,r){try{const o=new URL(e);return o.protocol==="https:"||o.protocol==="http:"?o.toString():r}catch{return r}}function i(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function z(e,r){const o=new Map;return r.forEach(t=>{const n=t.properties.name.replace(/^Leg \d+:\s*/,"").split(",")[0].trim();o.set(n.toLowerCase(),t.geometry.coordinates)}),e.map((t,n)=>{const s=o.get(t.Map_Name.toLowerCase())??K(t.Map_Name,n);return{...t,lng:s[0],lat:s[1]}})}function K(e,r){const o={Giethoorn:[6.083,52.74],Lübeck:[10.687,53.866],Flåm:[7.114,60.861],Geiranger:[7.207,62.101],Lillehammer:[10.466,61.115],Karlstad:[13.511,59.402],Jönköping:[14.161,57.782],Helsingborg:[12.694,56.046],Odense:[10.388,55.403],Schwerin:[11.413,53.635],Poznań:[16.925,52.406],Olomouc:[17.251,49.594],"Český Krumlov":[14.315,48.812],Hallstatt:[13.649,47.562],Salzburg:[13.055,47.81],Ortisei:[11.674,46.576],"St. Moritz":[9.839,46.498],Grindelwald:[8.041,46.624],"Chamonix-Mont-Blanc":[6.869,45.923],Annecy:[6.129,45.899],Avignon:[4.805,43.949],Collioure:[3.083,42.526],Zaragoza:[-.889,41.648],Salamanca:[-5.664,40.97],Évora:[-7.913,38.571],Granada:[-3.599,37.178],Alicante:[-.481,38.345],Valencia:[-.376,39.469],"Port of Barcelona":[2.173,41.353],"Port of Civitavecchia":[11.795,42.094],Venice:[12.315,45.44],Ljubljana:[14.505,46.056],"Plitvice Lakes National Park":[15.582,44.865],Split:[16.44,43.508],Dubrovnik:[18.094,42.651],Kotor:[18.771,42.424],Shkodër:[19.512,42.069],Gjirokastër:[20.138,40.075],Ioannina:[20.851,39.665],Patras:[21.735,38.246],Athens:[23.728,37.984],Delphi:[22.501,38.482],Meteora:[21.63,39.721],Skopje:[21.431,41.998],Niš:[21.896,43.321],Belgrade:[20.457,44.817],"Novi Sad":[19.833,45.267],Linz:[14.286,48.306],Regensburg:[12.102,49.013],Würzburg:[9.953,49.792],Bacharach:[7.769,50.057],Cologne:[6.96,50.938],"Amsterdam Airport Schiphol":[4.763,52.31]};return o[e]?o[e]:[4+r*.22,52-r*.04]}function X(e,r,o,t){const l=(e- -10)/36*o,a=t-(r-36)/28*t;return{x:l,y:a}}function T(){const e=document.querySelector("#route-canvas");if(!e||!g.length)return;const r=e.getBoundingClientRect(),o=Math.min(window.devicePixelRatio||1,2);e.width=Math.floor(r.width*o),e.height=Math.floor(r.height*o);const t=e.getContext("2d");t.scale(o,o),t.clearRect(0,0,r.width,r.height);const n=t.createLinearGradient(0,0,r.width,r.height);n.addColorStop(0,"#17324d"),n.addColorStop(.55,"#23556a"),n.addColorStop(1,"#6a8d6d"),t.fillStyle=n,t.fillRect(0,0,r.width,r.height),t.save(),t.globalAlpha=.2,t.strokeStyle="#d7e7db";for(let l=0;l<18;l+=1)t.beginPath(),t.moveTo(0,l*38+10),t.lineTo(r.width,l*28-40),t.stroke();for(let l=0;l<20;l+=1)t.beginPath(),t.moveTo(l*58-100,0),t.lineTo(l*42+40,r.height),t.stroke();t.restore();const s=g.map(l=>X(l.lng,l.lat,r.width,r.height));t.lineCap="round",t.lineJoin="round",t.strokeStyle="rgba(8, 22, 38, .55)",t.lineWidth=10,N(t,s),t.strokeStyle="#ffffff",t.lineWidth=5,N(t,s),t.strokeStyle="#2d8cff",t.lineWidth=3,N(t,s);const d=Math.max(1,Math.floor(b*(s.length-1)));t.strokeStyle="#ffcf5a",t.lineWidth=6,N(t,s.slice(0,d+1)),s.forEach((l,a)=>{const p=a===m;t.beginPath(),t.fillStyle=p?"#ff7a1a":"#1fb67a",t.strokeStyle="#fff",t.lineWidth=p?4:2,t.arc(l.x,l.y,p?8:5,0,Math.PI*2),t.fill(),t.stroke()});const u=s[m];u&&(t.beginPath(),t.strokeStyle="#ffcf5a",t.lineWidth=2,t.arc(u.x,u.y,18+Math.sin(Date.now()/260)*4,0,Math.PI*2),t.stroke())}function N(e,r){r.length&&(e.beginPath(),e.moveTo(r[0].x,r[0].y),r.slice(1).forEach(o=>e.lineTo(o.x,o.y)),e.stroke())}function Y(){const e=g[m],r=L.filter(o=>Number(o.Stop_Order)===Number(e.Order));return S==="All"?r:r.filter(o=>o.Priority===S)}function J(e){const r=Number(e.Recommended_Nights||0),o=Number(e.Approx_Miles_From_Previous||0),t=L.some(n=>Number(n.Stop_Order)===Number(e.Order));return r<=1&&o>=120?{route_function:"Route protection / relaxed self-drive pacing",why_stop_exists:"This stop keeps the road trip comfortable instead of turning the day into a bus-tour transfer.",worth_sightseeing:t?"Local guide items exist.":"CONTENT_PENDING",best_60_minute_experience:t?"Use the highest-priority nearby guide item.":"CONTENT_PENDING",skip_if_tired:"Dinner, sleep, and continue without guilt."}:{route_function:e.Route_Theme||"Destination base",why_stop_exists:e.Why_This_Stop||"CONTENT_PENDING",worth_sightseeing:t?"Yes, use the attraction guide below.":"CONTENT_PENDING",best_60_minute_experience:t?"Pick one nearby priority attraction.":"CONTENT_PENDING",skip_if_tired:"Protect rest when arrival is late or weather is poor."}}function Z(e){const r=e.toLowerCase(),o=g.findIndex(t=>t.Map_Name.toLowerCase()===r||t.Map_Name.toLowerCase().includes(r)||t.Location.toLowerCase().includes(r));return Math.max(0,o)}function Q(e){const r=e.toLowerCase(),o=g.findIndex(t=>t.Map_Name.toLowerCase()===r||t.Map_Name.toLowerCase().includes(r)||t.Location.toLowerCase().includes(r));return o>=0?o:g.length-1}function y(e){m=Math.max(0,Math.min(g.length-1,e)),b=m/Math.max(1,g.length-1)}function ee(){const e=g[m],r=f==="cn"?`${e.Map_Name}。${e.Why_This_Stop} 秋季窗口：${e.Autumn_Target_Window}。`:`${e.Map_Name}. ${e.Country}. Autumn window: ${e.Autumn_Target_Window}. ${e.Route_Theme}.`;window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(r);o.lang=f==="cn"?"zh-CN":"en-US",window.speechSynthesis.speak(o)}function h(){const e=g[m],r=Y(),o=B(e.Map_Name),t=J(e),n=F({driveMiles:Number(e.Approx_Miles_From_Previous||0),hotelChange:m>0,ferry:e.Map_Name.toLowerCase().includes("ferry")||e.Location.toLowerCase().includes("port"),majorAttractions:Math.min(2,r.length),walkingHours:r.length?2.5:1}),s=["All",...Array.from(new Set(L.map(a=>a.Priority))).filter(Boolean)],d=A(e.Location),u=M(e.Location),l=typeof e.lat=="number"&&typeof e.lng=="number"?H(e.lat,e.lng):x(e.Location);R.innerHTML=`
    <main class="${E==="night"?"night-mode":"daylight-mode"}">
      <section class="hero">
        <div class="hero__copy">
          ...
          <div class="hero__actions">
            <a class="button primary" href="${w.myMapsOpen}" target="_blank" rel="noreferrer">Open My Maps</a>
      ...
      <section class="toolbar" aria-label="Trip controls">
        ...
        <button id="mode" class="button">${E==="daylight"?"Night mode":"Daylight"}</button>
      ...
      <section class="layout">
        <aside class="stops" aria-label="Route stops">
          ${U.map(({name:a,from:p,to:v,opensAt:I})=>{const P=Z(I),G=Q(v);return`
                  <button class="drive-chip ${m>=P&&m<=G?"active":""}" data-drive="${P}">
                    <strong>${i(a)}</strong>
                    <span>${i(p)} → ${i(v)}</span>
                  </button>
                `}).join("")}
        ...
        <section class="guide">
          ...
          <div class="attraction-tools">
            ...
            <select id="priority-filter" aria-label="Filter attractions by priority">
              ${s.map(a=>`<option value="${i(a)}" ${a===S?"selected":""}>${i(a)}</option>`).join("")}
            </select>
          </div>

          <div class="attractions">
            ${r.length?r.map(a=>{const p=D(a.Google_Maps_Search_URL,A(a.Location)),v=a.Source_URL?D(a.Source_URL,""):"";return`
                        <article class="attraction-card">
                          ...
                          <div class="card-links">
                            ...
                            ${v?`<a href="${v}" target="_blank" rel="noreferrer">Source</a>`:""}
                          </div>
                        </article>
  ...
  `,te(),T()}function te(){document.querySelectorAll("[data-stop]").forEach(e=>{e.addEventListener("click",()=>{y(Number(e.dataset.stop)),_=!1,h()})}),document.querySelectorAll("[data-drive]").forEach(e=>{e.addEventListener("click",()=>{y(Number(e.dataset.drive)),_=!1,h()})}),document.querySelector("#prev-stop")?.addEventListener("click",()=>{y(m-1),h()}),document.querySelector("#next-stop")?.addEventListener("click",()=>{y(m+1),h()}),document.querySelector("#play")?.addEventListener("click",()=>{_=!_,h()}),document.querySelector("#mode")?.addEventListener("click",()=>{E=E==="daylight"?"night":"daylight",h()}),document.querySelector("#lang")?.addEventListener("click",()=>{f=f==="cn"?"en":"cn",h()}),document.querySelector("#narrate")?.addEventListener("click",ee),document.querySelector("#priority-filter")?.addEventListener("change",e=>{S=e.target.value,h()}),document.querySelector("#route-progress")?.addEventListener("input",e=>{y(Number(e.target.value)),_=!1,h()}),document.querySelector("#duration")?.addEventListener("change",e=>{c={...c,duration:e.target.value},h()}),document.querySelector("#visitor-profile")?.addEventListener("change",e=>{c={...c,visitorProfile:e.target.value},h()}),document.querySelector("#pace")?.addEventListener("change",e=>{c={...c,pace:e.target.value},h()}),document.querySelector("#drive-profile")?.addEventListener("change",e=>{c={...c,drivingPreference:e.target.value},h()}),document.querySelector("#theme")?.addEventListener("change",e=>{c={...c,theme:e.target.value},h()})}async function re(){const[e,r,o]=await Promise.all([fetch(`${C}data/route-stops.csv`).then(t=>t.text()),fetch(`${C}data/attractions.csv`).then(t=>t.text()),fetch(`${C}data/route-points.geojson`).then(t=>t.json())]);g=z(k(e),o.features),L=k(r),h(),requestAnimationFrame(O)}function O(){_&&!W&&g.length&&(b=(b+8e-4)%1,m=Math.round(b*(g.length-1)),T()),requestAnimationFrame(O)}window.addEventListener("resize",T);re().catch(e=>{R.innerHTML=`<main class="error"><h1>Travel guide failed to load</h1><pre>${i(String(e))}</pre></main>`});
