      ...
      <section class="hero">
        <div class="hero__copy">
          ...
          <div class="hero__actions">
            <a class="button primary" href="${$.myMapsOpen}" target="_blank" rel="noreferrer">Open My Maps</a>
      ...
      <section class="layout">
        ...
        <section class="guide">
          ...
          <div class="attractions">
            ${r.length?r.map(a=>{const p=R(a.Google_Maps_Search_URL,A(a.Location)),v=a.Source_URL?R(a.Source_URL,""):"";return`
